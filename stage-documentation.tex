...
\cprotect\subsection{\verb|\copyrightnotice{<copyright information>}|}
\verb|\copyrightnotice| places copyright information, including the copyright symbol, above the address block. Note that most books on writing warn you \emph{not} to place copyright notices on submissions. This command is available to you should you choose to ignore that advice.

\cprotect\subsection{\verb|\draft{<draft #>}|}

\verb|\draft| places draft number information below the address block. Note that most books on writing warn you \emph{not} to place draft numbers on submissions, but rather to present your work as though it sprang Athena-like from your head. This command is available to you should you choose to ignore that advice.
...
Use \verb|\initsd| for character stage directions given before (or in place of) dialogue.

Use \verb|\charsd| for intra-dialogue stage directions.

\chapter{Putting It All Together}

Here is a script template formatted with \LaTeX\ and \texttt{stage.cls}. It should provide you with an idea of how to use \texttt{stage.cls}.
...
If you have any questions on \texttt{stage.cls}, please feel free to contact the maintainer at \url{rrt@sc3d.org}.
